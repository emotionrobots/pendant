...
class ListBox(Widget):
  ...
  #----------------------------------------------
  def _addTextBox(self, pos, dim, margin=[2,2], text="", font=TTFont(15),
  ...
  def addEntry(self, ord, text="", isSelectable=True):
    ...
    textBox = self._addTextBox(pos, self.dim, self.margin, text=text, font=self.font,
    ...
    if self.isVisible:
      ...
      if (display is not None) and (page is not None):
        if self.imageFile != None:
          self.image = display.loadImage(self.imageFile)

        if self.image is not None:
          self.image = self.image.convert("L")
          if (self.dim[0] > 0 and self.dim[1] > 0): 
            self.image = self.image.resize(self.dim)
          display.overlay(page, (self.pos[1], self.pos[0]), self.image)
...
class UI(Widget):
  ...
  def __init__(self, display, btnFunc):
    ...
    #  Blank background
    blank = self.addImageBox(pos=[0,30], imageFile="/etc/PiBeacon/pics/blank.bmp")
    self.isSelectable = False 
  ...
  #----------------------------------------------
  def addRect(self, pos, dim, margin=[0,0], outline=Color.black, fill=Color.white):
    rect = Rect()
    rect.dim = dim
    rect.pos = pos
    rect.margin = margin 
  ...
  #  Returns the text instance
  #----------------------------------------------
  def addTextBox(self, pos, dim, margin=[2,2], text="", font=TTFont(15), 
         textColor=Color.black, outline=Color.black, fill=Color.white):
    textBox = TextBox()
    textBox.dim = dim
    textBox.pos = pos
  ...
  #  Add ImageBox
  #----------------------------------------------
  def addImageBox(self, pos, dim=[0,0], image=None, imageFile=None):
    imageBox = ImageBox()
    imageBox.image = image 
    imageBox.imageFile = imageFile
    imageBox.pos = pos
    imageBox.dim = dim
    imageBox.margin = [0,0] 
  ...
  #  Add a ListBox 
  #----------------------------------------------
  def addListBox(self, pos, dim, margin=[2,2], font=TTFont(15), dir='v',
         textColor=Color.black, outline=Color.black, fill=Color.white):
    listBox = ListBox()
    listBox.dim = dim 
    listBox.pos = pos
  ...
  #  Add a DropList 
  #----------------------------------------------
  def addDropList(self, pos, dim, margin=[2,2], text="", font=TTFont(15), offset=[30,30], 
         textColor=Color.black, outline=Color.black, fill=Color.white):
  ...
  #  Add a ticker tape 
  #----------------------------------------------
  def addTickerTape(self, pos, dim, margin=[0,0], text="", font=TTFont(15),  
                textColor=Color.black, outline=Color.black, fill=Color.white):
    ticker = TickerTape()
    ticker.pos = pos
    ticker.dim = dim
